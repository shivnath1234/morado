import{j as t,c as m,L as _,M as d,r as f,C as v,a as p,b as x,V as y,d as c,S as h,O as g,e as j,f as z,G as w}from"./index-BQJMX4Ab.js";const b="mesh",C="planeGeometry",M="primitive",P=()=>t.jsxs("div",{className:"absolute top-0 left-0 right-0 p-8 flex justify-between items-center z-50",children:[t.jsxs(_,{to:"/",className:"flex items-center gap-2",children:[t.jsx(d,{className:"w-10 h-10"}),t.jsx("span",{className:"text-xl font-bold text-white tracking-tight",children:"Morado"})]}),t.jsx(_,{to:"/",className:"text-white/60 hover:text-white transition-colors text-sm font-medium",children:"Back to home"})]}),$=({animationSpeed:e=10,opacities:i=[.3,.3,.3,.5,.5,.5,.8,.8,.8,1],colors:o=[[0,255,255]],containerClassName:n,dotSize:u,showGradient:a=!0,reverse:s=!1})=>t.jsxs("div",{className:m("h-full relative w-full",n),children:[t.jsx("div",{className:"h-full w-full",children:t.jsx(N,{colors:o??[[0,255,255]],dotSize:u??3,opacities:i??[.3,.3,.3,.5,.5,.5,.8,.8,.8,1],shader:`
